...
<button style="margin: 19px;" type="button" class="btn-sm btn-primary" data-toggle="modal" data-target=".bd-example-modal-lg"><span class="fa fa-plus"></span> Tambah Role</button>
<div class="row">
    <div class="col-sm-6">
