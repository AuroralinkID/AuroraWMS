...
<h1>
    <span class="fa fa-filter"></span> Kategori Perusahaan
                                        ...
                                        <div class="box-body">
                                            ...
                                            <div class="form-group col-md-6 required ">
                                                <label for="name" class="control-label">Warna</label>
                                                    <div class="input-group">
                                                        <div class="input-group-addon"><i class="fa fa-id-card-o"></i></div>
                                                        <input class="form-control" placeholder="Masukkan Nama Role" required="required" name="warna" type="color" id="warna">
                                                    </div>
                                                </div>
                                            <div class="form-group col-md-6 required ">
            ...
            <table id="example2" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
                ...
                <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{$key+1}}</td>
                            <td>{{$kat->name}}</td>
                            <td style="background-color:{{$kat->warna}}"></td>
                                                ...
                                                <div class="box box-warning">
                                                    <div class="modal-body">
                                                        <div class="box-body">
                                                            ...
                                                            <div class="form-group col-md-6 required ">
                                                                <label for="name" class="control-label" ><button class="btn btn-lg" style="background-color:{{$kat->warna}}"></button></label>
                                                            </div>
                                                            <div class="form-group col-md-6 required ">
                                                        ...
                                                        <form method="POST" action="{{ route('kategori.update', $kat->id) }}" accept-charset="UTF-8" role="form" class="form-loading-button" enctype="multipart/form-data"><input name="_method" type="hidden" value="PATCH">
                                                            ...
                                                            <div class="box-body">
                                                                ...
                                                                <label for="name" class="control-label">Warna</label>
                                                                    <div class="input-group">
                                                                        <div class="input-group-addon"><i class="fa fa-id-card-o"></i></div>
                                                                    <input class="form-control" placeholder="Masukkan Nama" required="required" name="warna" type="color" value="{{$kat->warna}}" id="warna">
                                                                    </div>
                                                                </div>
                                                                <div class="form-group col-md-6 required ">
